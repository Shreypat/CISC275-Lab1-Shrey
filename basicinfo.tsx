...
const yourName : String = "Shrey Patel";
let yourPronouns : String = "He/Him";
const yourMajor : String = "Computer Science";
let classification : String = "junior";
let oneExcite : String = "Learn how to colab with others and make a website";
let anyConcerns : String = "I am worried about the complexity of the projects";
let funFact : String = "I like to play games";
